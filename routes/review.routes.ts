...
router.post('/event/:eventId', authenticate, authorize('CUSTOMER'), validate(reviewSchema), ctrl.createReview.bind(ctrl));
router.put('/:id', authenticate, validate(reviewSchema), ctrl.updateReview.bind(ctrl));
